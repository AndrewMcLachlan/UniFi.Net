...
/// <summary>
/// Represents a filter that matches values less than a specified threshold.
/// </summary>
...
public class LessThanFilter<T>(string field, T value, bool inclusive = false) : SingleValueFilter<T>(field, value)
    where T : notnull
{
    /// <summary>
    ...
    /// <inheritdoc/>
    protected override string Operator => Inclusive ? "le" : "lt";
}
