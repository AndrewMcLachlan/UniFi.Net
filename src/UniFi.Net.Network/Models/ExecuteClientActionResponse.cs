...
/// </summary>
/// <param name="Action">The client action that was executed.</param>
...
public record ExecuteClientActionResponse(ClientAction Action, ClientAuthorization? RevokedAuthorization, ClientAuthorization? GrantedAuthorization);